...
import View from '@/views/security-anti-terror/index.vue';
...
// security-anti-terror 子应用入口（wujie-shell）。复用主壳已验证的 views/security-anti-terror/index.vue，独立 Pinia 挂载；
...
// 经由 @/services/http 单例的 adapter 拦截子应用请求，避免跨源/无后端 Network Error。
