...
import type { PlanActionCard, PlanCombatResource } from '@/services/map-data/planMatrixMock';
...
import { EMERGENCY_PHASES, type EmergencyPhase } from '@/services/map-data/emergencyProcessData';
