...
const defaultBgImage = new URL(
  '../../assets/map/mock-cameras/outdoor_storage_tanks_1782731405157.png',
  import.meta.url,
).href;

const highAltitudeImage = new URL(
  '../../assets/map/mock-cameras/high-altitude-ar-petrochemical.png',
  import.meta.url,
).href;
...
const reactorImage = new URL(
  '../../assets/map/mock-cameras/chemical_plant_reactor_1782731378222.png',
  import.meta.url,
).href;
const pipeRackImage = new URL(
  '../../assets/map/mock-cameras/chemical_factory_pipes_1782731393637.png',
  import.meta.url,
).href;
const fireSceneImage = new URL(
  '../../assets/map/semantic-scenes/fire-alarm-pipe-rack.png',
  import.meta.url,
).href;
const weatherSceneGrid = new URL(
  '../../assets/map/semantic-scenes/typhoon-flood-cctv-grid.png',
  import.meta.url,
).href;
const accidentSceneGrid = new URL(
  '../../assets/map/semantic-scenes/accident-emergency-cctv-grid.png',
  import.meta.url,
).href;
...
const handlePlaybackCommand = (cmd: PlaybackCmd) => {
