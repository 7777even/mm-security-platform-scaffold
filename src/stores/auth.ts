...
export type RoleId = 'commander' | 'dispatcher' | 'shift-leader' | 'operator-inner' | 'operator-outer'
...
export const ROLE_PERMS: Record<RoleId, string[]> = {
  commander: ['dashboard:view', 'fire-alarm:view', 'fire-alarm:ack', 'video:view', 'system:user:view', 'system:device-code:view'],
  dispatcher: ['dashboard:view', 'fire-alarm:view', 'fire-alarm:ack', 'video:view'],
  'shift-leader': ['dashboard:view', 'fire-alarm:view', 'video:view'],
